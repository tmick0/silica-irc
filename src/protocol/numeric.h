...
constexpr char NUM_ERR_NOSUCHNICK[] = "401";
...
constexpr char NUM_ERR_NOSUCHSERVER[] = "402";
...
constexpr char NUM_ERR_NOSUCHCHANNEL[] = "403";
...
constexpr char NUM_ERR_CANNOTSENDTOCHAN[] = "404";
...
constexpr char NUM_ERR_TOOMANYCHANNELS[] = "405";
...
constexpr char NUM_ERR_WASNOSUCHNICK[] = "406";
...
constexpr char NUM_ERR_TOOMANYTARGETS[] = "407";
...
constexpr char NUM_ERR_NOTEXTTOSEND[] = "412";
...
constexpr char NUM_ERR_NOTOPLEVEL[] = "413";
...
constexpr char NUM_ERR_WILDTOPLEVEL[] = "414";
...
constexpr char NUM_ERR_UNKNOWNCOMMAND[] = "421";
...
constexpr char NUM_ERR_ERRONEUSNICKNAME[] = "432";
...
constexpr char NUM_ERR_NICKNAMEINUSE[] = "433";
...
constexpr char NUM_ERR_NICKCOLLISION[] = "436";
...
constexpr char NUM_ERR_USERNOTINCHANNEL[] = "441";
...
constexpr char NUM_ERR_NOTONCHANNEL[] = "442";
...
constexpr char NUM_ERR_USERONCHANNEL[] = "443";
...
constexpr char NUM_ERR_USERSDISABLED[] = "446";
...
constexpr char NUM_ERR_NOTREGISTERED[] = "451";
...
constexpr char NUM_ERR_NEEDMOREPARAMS[] = "461";
...
constexpr char NUM_ERR_ALREADYREGISTRED[] = "462";
...
constexpr char NUM_ERR_NOPERMFORHOST[] = "463";
...
constexpr char NUM_ERR_PASSWDMISMATCH[] = "464";
...
constexpr char NUM_ERR_YOUREBANNEDCREEP[] = "465";
...
constexpr char NUM_ERR_UNKNOWNMODE[] = "472";
...
constexpr char NUM_ERR_INVITEONLYCHAN[] = "473";
...
constexpr char NUM_ERR_BANNEDFROMCHAN[] = "474";
...
constexpr char NUM_ERR_BADCHANNELKEY[] = "475";
...
constexpr char NUM_ERR_NOPRIVILEGES[] = "481";
...
constexpr char NUM_ERR_CHANOPRIVSNEEDED[] = "482";
...
constexpr char NUM_ERR_CANTKILLSERVER[] = "483";
...
constexpr char NUM_ERR_NOOPERHOST[] = "491";
...
constexpr char NUM_ERR_UMODEUNKNOWNFLAG[] = "501";
...
constexpr char NUM_ERR_USERSDONTMATCH[] = "502";
...
constexpr char NUM_RPL_WHOISOPERATOR[] = "313";
...
constexpr char NUM_RPL_WHOISCHANNELS[] = "319";
...
constexpr char NUM_RPL_WHOWASUSER[] = "314";
...
constexpr char NUM_RPL_ENDOFWHOWAS[] = "369";
...
constexpr char NUM_RPL_TRACEHANDSHAKE[] = "202";
...
constexpr char NUM_RPL_TRACEUNKNOWN[] = "203";
...
constexpr char NUM_RPL_TRACEOPERATOR[] = "204";
...
constexpr char NUM_RPL_TRACENEWTYPE[] = "208";
...
constexpr char NUM_RPL_STATSCOMMANDS[] = "212";
...
constexpr char NUM_RPL_STATSCLINE[] = "213";
...
constexpr char NUM_RPL_STATSNLINE[] = "214";
...
constexpr char NUM_RPL_STATSILINE[] = "215";
...
constexpr char NUM_RPL_STATSKLINE[] = "216";
...
constexpr char NUM_RPL_STATSYLINE[] = "218";
...
constexpr char NUM_RPL_ENDOFSTATS[] = "219";
...
constexpr char NUM_RPL_STATSLLINE[] = "241";
...
constexpr char NUM_RPL_STATSUPTIME[] = "242";
...
constexpr char NUM_RPL_STATSOLINE[] = "243";
...
constexpr char NUM_RPL_STATSHLINE[] = "244";
...
constexpr char NUM_RPL_LUSERCHANNELS[] = "254";
